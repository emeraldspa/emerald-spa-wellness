		...
		<nav class="em-nav" aria-label="<?php echo esc_attr__( 'Primary', 'emerald' ); ?>">
			...
			<ul class="em-nav__list" id="em-primary-menu">
				...
				<li class="em-nav-item em-nav-item--book">
					<a class="em-btn em-btn--solid em-nav-book" href="https://www.fresha.com/book-now/emerald-spa-wellness-centre-qnp9ba1m/all-offer?share=true&amp;pId=1477270" target="_blank" rel="noopener noreferrer"><?php esc_html_e( 'Book Now', 'emerald' ); ?></a>
				</li>
			</ul>
		</nav>
		<!-- /wp:html -->
