...
function embo_render_quick_actions() {
        $links = array(
                'Promotions'       => array( admin_url( 'edit.php?post_type=promotion' ), false ),
                'Add a promotion'  => array( admin_url( 'post-new.php?post_type=promotion' ), false ),
                'Treatments'       => array( admin_url( 'edit.php?post_type=treatment' ), false ),
                'Add a treatment'  => array( admin_url( 'post-new.php?post_type=treatment' ), false ),
                'Guest reviews'    => array( admin_url( 'edit.php?post_type=testimonial' ), false ),
                'Media library'    => array( admin_url( 'upload.php' ), false ),
                'View the website' => array( 'https://emeraldspacc.com', true ),
