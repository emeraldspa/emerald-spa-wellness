...
/**
 * The light stacked lockup ships with the theme; fall back to the media
 * library custom logo if the theme folder ever moves.
 */
function emerald_login_logo_url() {
	if ( file_exists( get_theme_root() . '/emerald/assets/img/lockup-stacked-light.png' ) ) {
		return get_theme_root_uri() . '/emerald/assets/img/lockup-stacked-light.png';
	}
