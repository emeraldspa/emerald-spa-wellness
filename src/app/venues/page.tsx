...
export const metadata: Metadata = {
  ...
  description:
    'Host your celebration at Emerald Spa and Wellness Centre in Windhoek West. Gender reveals, birthday parties, corporate events and family gatherings, with the space, the garden and the team to make it memorable.',
    ...
    <>
      <main id="main">
          ...
          <div className="grid items-start gap-12 lg:grid-cols-2">
            <FadeUp>
              <article id="story-gender-reveal" className="scroll-mt-28">
                ...
                <p className="mt-5 max-w-xl leading-relaxed text-ink/70 text-pretty">
                  The big moment happened in the garden, with the reveal planned around a
                  hydrotherapy afternoon for the family. What started as a soak became the
                  surprise of the day, and the balloons told the story before anyone said a word.
                </p>
                <div className="mt-8">
                  <VideoReel
            ...
            <FadeUp delay={0.08}>
              <article id="story-party" className="scroll-mt-28">
                ...
                <p className="mt-5 max-w-xl leading-relaxed text-ink/70 text-pretty">
                  The venue became a private party for the night: tables under the trees, the
                  lounge set up for guests, and the team moving between the garden and the
                  hydrotherapy suite all evening. One venue, a whole evening of moods.
                </p>
                <div className="mt-8">
                  <VideoReel
        ...
        <section className="surface-panel border-b border-ink/10 py-20 md:py-28">
          ...
          <div className="shell mt-12 columns-2 gap-5 lg:columns-3 [column-fill:balance]">
            {PARTY_PHOTOS.map((slug, i) => (
              <FadeUp key={slug} delay={(i % 3) * 0.06} className="mb-5 break-inside-avoid">
        ...
        {/* Book the venue */}
        <section id="book-venue" className="surface-stone-black relative scroll-mt-24 py-20 text-ground md:py-28">
