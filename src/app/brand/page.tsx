    ...
    <>
        ...
        <section className="shell border-b border-ink/10 py-16">
          ...
          <div className="mt-8 grid gap-12 md:grid-cols-2">
            <div>
              <p className="eyebrow text-emerald-600">Display: Radley</p>
              <p className="display mt-4 text-5xl">Restore Balance Glow</p>
              <p className="mt-4 text-sm text-ink/65">
                Used for every heading, set in the single 400 weight. Line height 0.92, letter
                spacing minus 0.022em. The open, warm forms carry the calm of the gemstone
                without decoration.
              </p>
            </div>
            <div>
              <p className="eyebrow text-emerald-600">Interface: Poppins</p>
              <p className="mt-4 text-2xl">Massages, facials, hydrotherapy, nails</p>
              <p className="mt-4 text-sm text-ink/65">
                Used for body copy, navigation, prices, and all interface text. Poppins&rsquo;
                geometric letterforms pair with the Radley display. Eyebrow labels run
                uppercase at 0.6875rem with 0.18em tracking.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="shell border-b border-ink/10 py-16">
          ...
          <p className="mt-6 max-w-2xl text-ink/70 text-pretty">
            ...
            gives them room and lets typography carry the polish. Every image ships as WebP
            with a JPEG fallback, with dimensions declared to prevent layout shift.
          </p>
          ...
          <figure className="mt-10 max-w-md">
            <div className="overflow-hidden rounded-2xl border border-ink/10">
              <Picture
                slug="emerald-stone"
                alt="The emerald stone that gave the spa its name, photographed in natural light"
                sizes="(max-width: 640px) 100vw, 400px"
                imgClassName="w-full h-auto"
              />
            </div>
            <figcaption className="mt-3 text-sm text-ink/65">
              The emerald stone, photographed in natural light. The gem&rsquo;s green and the
              rose gold of the rings both come from this single source.
            </figcaption>
          </figure>
        </section>
      </main>
