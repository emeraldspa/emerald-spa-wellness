...
import { Radley, Inter } from 'next/font/google';
 ...
 * neutral grotesk. Radley carries the gemstone warmth in a single quiet weight;
 * Inter handles all interface text.
 */
...
export const metadata: Metadata = {
  ...
  description:
    `Relax the body, renew the mind, rejuvenate the soul at Emerald Spa & Wellness Centre in Windhoek West. Massages, facials, hydrotherapy and nails. Rated ${site.rating} from ${site.reviewCount} verified reviews.`,
  keywords: [
    'spa Windhoek',
    'massage Windhoek',
    'facials Windhoek',
