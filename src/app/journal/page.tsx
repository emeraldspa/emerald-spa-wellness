...
export const metadata: Metadata = {
  title: 'Journal',
  description:
    'Stories, notes and announcements from Emerald Spa and Wellness Centre in Windhoek West.',
    ...
    <>
      <main id="main">
        <PageHero
          ...
          lede="Notes on treatments, the venue, the team and the rituals that make a visit to Windhoek West worth planning around."
        />
        ...
        <section className="shell border-t border-ink/10 py-16 md:py-24">
          {!journalReady || posts.length === 0 ? (
            ...
            <div className="columns-1 gap-6 sm:columns-2 lg:columns-3">
              {posts.map((post, i) => (
                <FadeUp key={post.id} delay={(i % 3) * 0.06} className="mb-6 break-inside-avoid">
