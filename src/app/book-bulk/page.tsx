...
export const metadata: Metadata = {
  title: 'Book in Bulk',
  description:
    'Arrange a group visit, a celebration or the venue at Emerald Spa & Wellness Centre, Windhoek West. Tell us who, how many and when, and we take it from there.',
  ...
  return (
    <>
      <main id="main">
          ...
          <div className="grid gap-12 lg:grid-cols-2">
            <FadeUp>
              ...
              <p className="mt-5 max-w-xl leading-relaxed text-ink/70 text-pretty">
                We plan group visits around a shared start and end time, so everyone arrives
                together and finishes together. Tell us how many of you there are and we will
                suggest the right combination of treatments.
              </p>
            </FadeUp>
            <FadeUp delay={0.08}>
              <div className="flex items-center gap-3">
              ...
              <p className="mt-5 max-w-xl leading-relaxed text-ink/70 text-pretty">
                The garden, the lounge and the hydrotherapy suite can be yours for the evening.
                See how two recent celebrations looked, then ask about availability and pricing.
              </p>
              <Link
                href="/venues"
            ...
            <div>
              ...
              <div className="mt-10 columns-2 gap-4 lg:columns-3">
                {BULK_PHOTOS.map((slug, i) => (
                  <FadeUp key={slug} delay={(i % 3) * 0.05} className="mb-4 break-inside-avoid">
        ...
        <section className="surface-clay border-b border-ink/10 py-16 md:py-24">
        ...
        <section className="shell py-14 md:py-16">
          <div className="flex flex-col items-start justify-between gap-6 rounded-2xl bg-emerald-900 px-8 py-8 text-ground sm:flex-row sm:items-center md:px-12">
            <div>
